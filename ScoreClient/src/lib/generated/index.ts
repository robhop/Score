...
import type {
  ...
  Mutation,
  SubscriptionTypeGenqlSelection,
  SubscriptionType,
} from './schema'
import {
  linkTypeMap,
...
export type SubscriptionResult<fields extends SubscriptionTypeGenqlSelection> =
  FieldsSelection<SubscriptionType, fields>
export const generateSubscriptionOp: (
  fields: SubscriptionTypeGenqlSelection & { __name?: string },
) => GraphqlOperation = function (fields) {
